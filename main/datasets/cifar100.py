...
@register_module(category="datasets", name="cifar100")
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if not os.path.isdir(root):
            raise ValueError(f"The specified root: {os.path.abspath(root)} does not exist")
        ...
        self.dataset = CIFAR100(self.root, train=True, download=True, transform=None)
